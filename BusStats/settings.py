"""
Django settings for BusStats project.
...
WSGI_APPLICATION = 'BusStats.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './BusStats.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
